...
@property (nonatomic, retain) NSArray <__kindof MCONetService *> * imapServers;
@property (nonatomic, retain) NSArray <__kindof MCONetService *> * popServers;
@property (nonatomic, retain) NSArray <__kindof MCONetService *> * smtpServers;
