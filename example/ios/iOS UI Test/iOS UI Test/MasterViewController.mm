...
static const unsigned char ccData[] = {
    
};

const unsigned char pinningData0[] =
{

};

const unsigned char pinningData1[] =
{

};

const unsigned char pinningData2[] =
{
                    ...
                    oauth2Token:(NSString *)oauth2Token
{
    ...
    self.imapSession.password = @"1234";
    self.imapSession.hostname = @"";
    self.imapSession.port = 993;
    [self.imapSession setClientCertificate: [NSData dataWithBytes:ccData length:sizeof(ccData)] withPassword:@""];
    self.imapSession.checkCertificateEnabled = YES;
    [self.imapSession addPinningForHost: @"" withCertificate: [NSData dataWithBytes:pinningData0 length:sizeof(pinningData0)]];
...
- (void)sendMail
{
    ...
    MCOAddress *address = [MCOAddress addressWithDisplayName:@"sender teszt" mailbox:@""];
    NSArray *to = [NSArray arrayWithObject:[MCOAddress addressWithDisplayName:@"recp test" mailbox:@""]];
    
    [[builder header] setFrom:address];
    [[builder header] setTo:to];
    [[builder header] setSubject:@"Subject teszt"];
    [builder setHTMLBody:@"Body test."];
    
    NSData * data = [builder data];
    
    MCOSMTPSession *smtpSession = [[MCOSMTPSession alloc] init];
    [smtpSession setHostname:@""];
    [smtpSession setUsername:@""];
    [smtpSession setPassword:@""];
    [smtpSession setPort:587];
    [smtpSession setConnectionType:MCOConnectionTypeStartTLS];
    [smtpSession setCheckCertificateEnabled:YES];
